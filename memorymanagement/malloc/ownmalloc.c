...
//how do you implement free?

int main ()
{

    //The first part of the example shows the addresses for ownmalloced locations
    int *i,*j=0;
    int counter=0;
    ...
    i = (int*) ownmalloc (5*sizeof(int));
    j = (int*) ownmalloc (5*sizeof(int));
    void * currentbrk=sbrk(0);
    printf("the location of brk after ownmalloc is %p\n",currentbrk);
